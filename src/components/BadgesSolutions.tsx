...
export default function BadgeSolutions() {
  // Inicializamos activeTab con 'ecommerce' para que esta solución sea la que se muestre por defecto
  ...
  // Modificamos handleBadgeClick para que siempre asigne el tab seleccionado
